...
with st.expander("more"):
    st.dataframe(apply_filter(DF_HISTORY).artist_name.value_counts()[0:100])
...
st.plotly_chart(fig)
with st.expander("more"):
    st.dataframe(apply_filter(DF_HISTORY).album_name.value_counts()[0:100])
...
st.plotly_chart(fig)
with st.expander("more"):
    st.write(apply_filter(DF_HISTORY).title.value_counts()[0:100])
